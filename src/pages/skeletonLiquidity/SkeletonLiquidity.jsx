...
import { SOL } from "../../utils/ContractAddresses";
import { tokens } from "../../utils/Tokens";

const SkeletonLiquidity = () => {
    ...
    <div className="">
      ...
      <div className="my-36 !px-5 md:!px-32 contain mx-auto relative">
        <div className="w-full">
          <div className="text-xl text-center">Deposit Liquidity</div>
          ...
          <div className="mt-5">
            {
              ...
              <>
                ...
                <div className="px-7 py-5 hover:!bg-gray-200 dark:hover:!bg-gray-900 dark:bg-darklight bg-white rounded-3xl border dark:border-darklight border-gray-300 relative overflow-hidden group">
...
export default SkeletonLiquidity;
