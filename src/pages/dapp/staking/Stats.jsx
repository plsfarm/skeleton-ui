...
const Stats = () => {
    ...
    return (
        <div className='relative pb-10 w-full'>
            <div className='py-10 md:py-20 contain mx-auto'>
                <div className='w-full'>
                    <div className="flex flex-col md:flex-row justify-between">
                        ...
                        <div>
                            <input type="text" placeholder="Search" className="border dark:border-gray-900 dark:bg-darklight border-gray-300 rounded-lg px-3 py-2 w-[300px]" />
                        </div>
                    </div>
                            ...
                            <div className="relative h-full w-full mt-3">
                                <div className="absolute left-0 top-0 z-10 grid h-[35px] w-[35px] place-items-center rounded-full border border-white/20 bg-dark">
                                    <div className="h-[25px] w-[25px]">
                                        <img src={'/pshareforcircle.png'} className="w-full object-contain" alt="" />
                                    </div>
                                </div>
                                <div className="absolute left-5 top-0 right-0 z-10 grid h-[35px] w-[35px] place-items-center rounded-full border border-white/20 bg-dark">
                                    <div className="h-[25px] w-[25px]">
                                        <img src={'/wpls.png'} className="w-full object-contain" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
